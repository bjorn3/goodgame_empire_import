...
fn test_with_prefix() {
    ...
    let mut data = io::Cursor::new(vec![0xAA, 0xAB /* Prefix */, 0x00, 0x00, 0x01, 0x02,
                                        0x03 /* FullMatch */, 0x00, 0x00, 0x04, 0x05,
                                        0x06 /* FullMatch */, 0x00, 0x00, 0x07,
                                        0x08 /* Suffix */]);
...
fn test_without_prefix() {
    let separator = [0x00, 0x00];
    let mut data = io::Cursor::new(vec![0x00, 0x00, 0x01, 0x02, 0x03 /* FullMatch */, 0x00,
                                        0x00, 0x04, 0x05, 0x06 /* FullMatch */, 0x00, 0x00,
                                        0x07, 0x08 /* Suffix */]);
...
fn test_skip_bug() {
    let separator = [0x00, 0x00];
    let mut data = io::Cursor::new(vec![0x00, 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
...
fn test_skip_bug2() {
    ...
    let mut data = io::Cursor::new(vec![0x01, 0x02, 0x03, 0x02, 0x02, 0x03, 0x04, 0x05, 0x06,
                                        0x07, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x01, 0x02,
                                        0x03, 0x08]);
